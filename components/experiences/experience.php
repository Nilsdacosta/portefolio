...
<div class="container">
    ...
    <p>Je m'appelle Nils Da Costa Cruz
        ...
        <br>
        J'ai grandis près de Nyons, dans un petit village de 180 habitants où j'ai appris à être autonome et débrouillard.
    </p>
    <hr>
    <h5 class="titreExp"><i class="fas fa-school"></i> Ma scolarité</h5>
    <p>
        Ma scolarité a débuté dans le Vercors dans un étalissement sport et nature où l'autonomie et la confiance étaient au centre de l'éducation.
        <br>
        Etant à l'internat j'ai aussi appris à vivre en groupe bien que je sois déjà le 5e d'une fratrie de 6 enfants.
        <br>
        Je suis ensuite revenu dans mon village d'origine et suis rentré au lycée ou j'ai suivi la fillière ES et j'ai obtenu mon Bac mention "talent" et c'est déjà pas mal.
        <br>
        Pendant cette période j'ai développé certaines passions plutôt courantes pour un lycéen :
        <br>
        - le Foot en club,
        <br>
    ...
    <h5 class="titreExp"><i class="fas fa-briefcase"></i> L'armée</h5>
        ...
        <br>
        A la fin de ma formation, j'ai découvert le développement grâce à un ami et ai commencé mon apprentissage en autodidacte.
        <br>
        Mon parcours n'en est encore qu'à ses débuts mais je continue d'apprendre et de vouloir apprendre et n'attends plus qu'une belle opportunité pour enfin débuter ma vie professionelle dans le monde informatique :).
    </p>
</div>
